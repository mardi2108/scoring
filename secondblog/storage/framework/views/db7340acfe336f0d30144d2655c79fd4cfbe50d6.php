...
<?php $__currentLoopData = $scores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $players => $scores): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <tr>
          ...
          <td></td>
        <form action="updatesys36" method="post">
          <?php echo csrf_field(); ?>
          <td><button class="btn btn-sm btn-primary">UpdateSys</button></td>
        </form>
        <tr>
        </table>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\secondblog\resources\views/product/index.blade.php ENDPATH**/ ?>