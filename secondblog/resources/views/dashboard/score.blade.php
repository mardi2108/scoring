...
<div class="d-inline justify-content-center card-body p-2" style="overflow-x:auto; width: 65%">
    <form action = "prosess" method = "post">
        ...
        <table id="players" class="justify-content-center table-bordered">
          ...
          <th>Nett</th>
            <tr>
              <td><input id="num1" onKeyup="sum();" type='number' name='h_one' value="{{ $score->h_one }}" style="width: 3em"/></td>
              <td><input id="num2" onKeyup="sum();" type='number' name='h_two' value="{{ $score->h_two }}" style="width: 3em"/></td>
              <td><input id="num3" onKeyup="sum();" type='number' name='h_three' value="{{ $score->h_three }}" style="width: 3em"/></td>
              <td><input id="num4" onKeyup="sum();" type='number' name='h_four' value="{{ $score->h_four }}" style="width: 3em"/></td>
              <td><input id="num5" onKeyup="sum();" type='number' name='h_five' value="{{ $score->h_five }}" style="width: 3em"/></td>
              <td><input id="num6" onKeyup="sum();" type='number' name='h_six' value="{{ $score->h_six }}" style="width: 3em"/></td>
              <td><input id="num7" onKeyup="sum();" type='number' name='h_seven' value="{{ $score->h_seven }}" style="width: 3em"/></td>
              <td><input id="num8" onKeyup="sum();" type='number' name='h_eight' value="{{ $score->h_eight }}" style="width: 3em"/></td>
              <td><input id="num9" onKeyup="sum();" type='number' name='h_nine' value="{{ $score->h_nine }}" style="width: 3em"/></td>
              <td><input id="num10" type='number' name='h_out' readonly="" value="{{ $score->h_out }}" onKeyup="math();" style="width: 3em"/></td>
              <td><input id="num40" type='number' name='gross' readonly="" value="{{ $score->gross }}" onKeyup="math();" style="width: 3em"/></td>
              <td><input id="num60" type='number' name='hcap' readonly="" value="{{$score->player()->first()->hcap}}" onKeyup="math();" style="width: 3em"/></td>
              <td><input id="num50" type='number' name='nett' readonly="" value="{{ $score->nett }}" style="width: 3em"/></td>
            </tr>
          <th>10</th>
          <th>11</th>
          <th>12</th>
          ...
          <th>Total</th>
        <tr>
          <td><input id="num11" onKeyup="sum();" type='number' name='h_ten' value="{{ $score->h_ten }}" style="width: 3em"/></td>
              <td><input id="num12" onKeyup="sum();" type='number' name='h_elev' value="{{ $score->h_elev }}" style="width: 3em"/></td>
              <td><input id="num13" onKeyup="sum();" type='number' name='h_twelv' value="{{ $score->h_twelv }}" style="width: 3em"/></td>
              <td><input id="num14" onKeyup="sum();" type='number' name='h_thrth' value="{{ $score->h_thrth }}" style="width: 3em"/></td>
              <td><input id="num15" onKeyup="sum();" type='number' name='h_fourth' value="{{ $score->h_fourth }}" style="width: 3em"/></td>
              <td><input id="num16" onKeyup="sum();" type='number' name='h_fivth' value="{{ $score->h_fivth }}" style="width: 3em"/></td>
              <td><input id="num17" onKeyup="sum();" type='number' name='h_sixth' value="{{ $score->h_sixth }}" style="width: 3em"/></td>
              <td><input id="num18" onKeyup="sum();" type='number' name='h_sevth' value="{{ $score->h_sevth }}" style="width: 3em"/></td>
              <td><input id="num19" onKeyup="sum();" type='number' name='h_eigth' value="{{ $score->h_eigth }}" style="width: 3em"/></td>
              <td><input id="num20" type='number' name='h_in' value="{{ $score->h_in }}" onKeyup="math();" style="width: 3em"/></td>
              <td><input id="num30" type='number' name='total' value="{{ $score->total }}" readonly style="width: 3em"/></td>
